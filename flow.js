...
function setup() {
    // Set up the canvas size to match the container size
    let canvas = createCanvas(windowWidth, windowHeight);
    canvas.parent('flow-field-container'); // Set the parent container to "column-two"
    noStroke();
  for (let i=0; i<num; i++) {
...
// Function to draw on the canvas (optional)
function draw() {
    // background(0);
    fill(0, 10);
    noStroke();
